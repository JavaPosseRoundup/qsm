...
import static org.freddy33.math.SphericalVector3i.D180
...
class SpaceTimeIntTest extends Specification {
    ...
    def "test single photon"() {
        ...
        st.activeEvents.any { MathUtils.almostEquals(it.point, new Point4i(2G * deltaX, 0G, 0G, 2G * bigDist), MathUtils.EPSILON_INT * 50G) }
        ...
        st.activeEvents.any { MathUtils.almostEquals(it.point, new Point4i(3G * deltaX, 0G, 0G, 3G * bigDist), MathUtils.EPSILON_INT * 50G) }
    ...
    def "test single electron"() {
        ...
        st.activeEvents.size() == 4
        st.deadEvents.size() == 0
        st.activeEvents.any { MathUtils.almostEquals(it.point, new Point4i(0G, 0G, ratio * D180, 0G)) }
        st.activeEvents.any { MathUtils.almostEquals(it.point, new Point4i(0G, 0G, -ratio * D180, 0G)) }
        ...
        st.deadEvents.size() == 4
        println "firstNextX=$deltaX, firstBigDist=$bigDist"
        st.activeEvents.any { MathUtils.almostEquals(it.point, new Point4i(deltaX, 0G, ratio * sin120, bigDist), MathUtils.EPSILON_INT * 50G) }
        st.activeEvents.any { MathUtils.almostEquals(it.point, new Point4i(deltaX, 0G, -ratio * sin120, bigDist), MathUtils.EPSILON_INT * 50G) }
        st.activeEvents.any { MathUtils.almostEquals(it.point, new Point4i(deltaX, ratio * D180, 0G, bigDist), MathUtils.EPSILON_INT * 50G) }
        st.activeEvents.any { MathUtils.almostEquals(it.point, new Point4i(deltaX, -ratio * D180, 0G, bigDist), MathUtils.EPSILON_INT * 50G) }
        ...
        st.activeEvents.size() == 4
        st.deadEvents.size() == 8
        st.activeEvents.any { MathUtils.almostEquals(it.point, new Point4i(2G * deltaX, 0G, ratio * D180, 2G * bigDist), MathUtils.EPSILON_INT * 50G) }
        st.activeEvents.any { MathUtils.almostEquals(it.point, new Point4i(2G * deltaX, 0G, -ratio * D180, 2G * bigDist), MathUtils.EPSILON_INT * 50G) }
        st.activeEvents.any { MathUtils.almostEquals(it.point, new Point4i(2G * deltaX, ratio * sin120, 0G, 2G * bigDist), MathUtils.EPSILON_INT * 50G) }
        st.activeEvents.any { MathUtils.almostEquals(it.point, new Point4i(2G * deltaX, -ratio * sin120, 0G, 2G * bigDist), MathUtils.EPSILON_INT * 50G) }
        ...
        st.activeEvents.size() == 4
        st.deadEvents.size() == 12
        st.activeEvents.any { MathUtils.almostEquals(it.point, new Point4i(3G * deltaX, 0G, ratio * sin120, 3G * bigDist), MathUtils.EPSILON_INT * 50G) }
        st.activeEvents.any { MathUtils.almostEquals(it.point, new Point4i(3G * deltaX, 0G, -ratio * sin120, 3G * bigDist), MathUtils.EPSILON_INT * 50G) }
        st.activeEvents.any { MathUtils.almostEquals(it.point, new Point4i(3G * deltaX, ratio * D180, 0G, 3G * bigDist), MathUtils.EPSILON_INT * 50G) }
        st.activeEvents.any { MathUtils.almostEquals(it.point, new Point4i(3G * deltaX, -ratio * D180, 0G, 3G * bigDist), MathUtils.EPSILON_INT * 50G) }
    }
